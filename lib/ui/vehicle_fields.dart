...
final List<VehicleField> vehicleFields = [
  ...
  VehicleField(
    ...
    'MIL 点灯後の距離',
    'km',
    (v) => v.distanceWithMilKm,
    (v, x) => v.distanceWithMilKm = x,
  ),
  VehicleField(
    '30',
    '消去後のウォームアップ',
    '回',
    (v) => v.warmupsSinceClear.toDouble(),
  ...
  VehicleField(
    ...
    '消去後の距離',
    'km',
    (v) => v.distanceSinceClearKm,
    (v, x) => v.distanceSinceClearKm = x,
  ),
  VehicleField(
    '3C',
    '触媒温度',
  ...
  VehicleField(
    ...
    '%',
    (v) => v.acceleratorPct,
    (v, x) => v.acceleratorPct = x,
  ),
  VehicleField(
    '4D',
    'MIL 点灯時間',
    'min',
    (v) => v.secondsWithMil / 60,
    (v, x) => v.secondsWithMil = x * 60,
  ),
  VehicleField(
    '4E',
    '消去後の時間',
    'min',
    (v) => v.secondsSinceClear / 60,
    (v, x) => v.secondsSinceClear = x * 60,
  ),
];
